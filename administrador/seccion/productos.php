...
<input type="text" required class="form-control" value="<?php echo $txtNombre; ?>" name="txtNombre" id="txtNombre" placeholder="Nombre Producto">
    </div>
...
<?php foreach($listaproductos as $producto) { ?>
        ...
        <tr>
            ...
            <td>
            <img class="img-thumbnail rounded" src="../../img/<?php echo $producto['imagen'];?>" width="100" alt="" srcset="">
